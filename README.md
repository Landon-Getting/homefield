...
*homefield relies on an online database for up-to-date college football
information. This database requires API keys which can be requested and
...
6.  Once the package and keys have been installed, homefield can be
