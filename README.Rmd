...
The homefield package helps gather data and create visuals to show spatial relevance of entities. Learn more in the *Getting started with homefield* article.
